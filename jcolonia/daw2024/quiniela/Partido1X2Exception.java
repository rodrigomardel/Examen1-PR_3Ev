 ...
 */
public class Partido1X2Exception extends DatoPartido1X2Exception {
	/**
	 ...
	 */
	public Partido1X2Exception(String mensaje, Throwable causa, boolean habilitarSupresión, boolean trazaPilaEditable) {
